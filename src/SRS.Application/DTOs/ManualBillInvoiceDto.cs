...
/// <summary>
/// Invoice data for manual bill, shaped for PDF generator (same structure as SaleInvoiceDto).
/// Vehicle section uses ItemDescription / placeholders for manual bills.
/// </summary>
public class ManualBillInvoiceDto
{
