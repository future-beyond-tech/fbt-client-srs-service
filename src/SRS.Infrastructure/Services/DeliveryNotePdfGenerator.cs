...
public sealed class DeliveryNotePdfGenerator(
    ...
    ILogger<DeliveryNotePdfGenerator> logger) : IPdfGenerator
{
    static DeliveryNotePdfGenerator()
    {
        QuestPDF.Settings.License = QuestPDF.Infrastructure.LicenseType.Community;
    }

    public async Task<byte[]> GeneratePdfAsync(SaleInvoiceDto invoice, CancellationToken cancellationToken = default)
    {
